        ...
        <section className="min-h-screen flex-1 px-5 py-6 lg:px-8">
          <header className="mb-8">
            ...
            <p className="mt-2 max-w-2xl text-sm text-gray-600">
              Generate real estate captions, educational posts, WhatsApp
              messages, property descriptions, and sales content.
            </p>
          </header>
          ...
          <section className="grid gap-6 xl:grid-cols-[1fr_1.2fr]">
            ...
            <div className="rounded-3xl border border-gray-200 bg-white p-6 shadow-sm">
              ...
              <div className="mt-6 rounded-2xl bg-gray-50 p-5 text-sm leading-7 text-gray-700">
                ...
                families, professionals, and investors looking for long-term
                value. Book an inspection with Tobee Empires today.
              </div>
            </div>
          </section>
