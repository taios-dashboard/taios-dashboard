          ...
          <section className="mt-6 grid gap-6 xl:grid-cols-[1.2fr_1fr]">
            <div className="rounded-3xl border border-gray-200 bg-white p-6 shadow-sm">
              ...
              <div className="mt-6 rounded-2xl bg-gray-50 p-5 text-sm leading-7 text-gray-700">
                ...
                investments, and luxury apartments. Hot leads should be
                prioritized for immediate sales follow-up, while warm leads
                should receive educational content and property comparison
                messages. Inspection booking activity is healthy and should be
                supported with WhatsApp reminders.
              </div>
            </div>
