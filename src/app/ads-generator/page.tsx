              ...
              <div className="mt-6 space-y-4">
                <div className="rounded-2xl bg-gray-50 p-5">
                  ...
                  <p className="mt-3 text-sm leading-7 text-gray-700">
                    Secure your future with verified land investment
                    opportunities in Abuja. Tobee Empires helps you access
                    strategic locations with strong growth potential and
                    professional guidance from enquiry to inspection.
                  </p>
                </div>
